...
import { DocusHomePageComponent } from './docus-home-page.component';
...
describe('DocusHomePageComponent', () => {
  ...
  beforeEach(() =>
    TestBed.configureTestingModule({
      imports: [DocusHomePageComponent],
      providers: [
  ...
  it('renders the spaces list for a user with spaces (all DI resolves, no NG0201)', () => {
    const fixture = TestBed.createComponent(DocusHomePageComponent);
