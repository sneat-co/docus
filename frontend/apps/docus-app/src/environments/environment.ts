...
// Single environment for docus — fail-safe by construction. appEnvironmentConfig
...
//
// Reuses the shared sneat production Firebase project (sneat-eur3-1) — docus
// shares auth, spaces and Firestore with the rest of the sneat ecosystem.
export const docusAppEnvironmentConfig: IEnvironmentConfig =
  appEnvironmentConfig({
    ...
    firebaseConfig: {
      ...
      // docus.app, docus-app.web.app, or a preview channel. (docus.app is a
